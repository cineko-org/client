...
export const PresetBeforeSeatMap: Story = { render: () => <Canvas><PresetPageView catalog={catalog} form={initialPresetForm} region="" theater="" auditoriumId="" auditoriums={[]} seatMap={null} pickedSeats={[]} catalogDates="" catalogMessage="" loadingCatalog={false} saving={false} forceCapture={false} onBack={noop} onRefreshCatalog={noop} onFormChange={noop} onRegionChange={noop} onTheaterChange={noop} onAuditoriumChange={noop} onCatalogDatesChange={noop} onDiscover={noop} onCapture={noop} onForceCaptureChange={noop} onToggleSeat={noop} onClearSeats={noop} onSave={noop} onReset={noop} /></Canvas> };
