...
func TestRunClaimedShowtimeUsesCentralFenceAndExactPayload(t *testing.T) {
	...
	base := &workerRepository{
		job: domain.MonitorJob{
			ID: "monitor", UserID: "user", PresetID: "preset", MovieID: "movie", Movie: "영화",
	...
	showtime := domain.Showtime{
		ID: "source", MovieID: "movie", Movie: "영화", TheaterID: "theater", AuditoriumID: "auditorium",
...
func TestClaimedBookingRejectsPayloadMismatch(t *testing.T) {
	...
	claimed := ClaimedBooking{
		Monitor: domain.MonitorJob{
			ID: "monitor", PresetID: "preset", MovieID: "movie", Movie: "영화", Status: domain.MonitorPending,
		...
		Showtime: domain.Showtime{
			ID: "source", MovieID: "other-movie", Movie: "다른 영화", TheaterID: "theater", AuditoriumID: "auditorium",
			Date: "2026-08-20", StartsAt: "20:00", EndsAt: "22:00",
